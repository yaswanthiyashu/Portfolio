      ...
      <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            ...
            time="2017-2021"
            place="Andhra University College Of Engineering For Women"
            info="I completed a bachelor's degree in mechanical engineering and undertook a project focused on sales prediction through machine learning during my academic tenure."
          />
