        ...
        <div ref={ref} className="relative w-[75%] mx-auto lg:w-[90%] md:w-full">
          ...
          <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2">
            <Details
              ...
              company="PEP Systems pvt ltd"
              // companyLink="https://google.com"
              time="2021-Present"
              address="Hyderabad"
              work="As a Frontend Development, I was an 
              integral part of our dynamic and innovative software development team. I implemented 
              clean,efficient, and maintainable code using modern frontend technologies such as 
              React js, Redux, Javascript, HTML, CSS. I worked with API's and translated wireframes
              into responsive and resusable components."
            />
